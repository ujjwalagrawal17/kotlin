...
class KotlinGenerateSecondaryConstructorAction : KotlinGenerateMemberActionBase<KotlinGenerateSecondaryConstructorAction.Info>() {
    ...
    private fun generateConstructor(
        ...
        if (classDescriptor.constructors.any {
                it.source.getPsi() is KtConstructor<*>
                        && equalTypes(it.valueParameters.map { it.varargElementType ?: it.type }, constructorParamTypes)
            }) return null
