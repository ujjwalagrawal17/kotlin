...
class KotlinAndroidGradleMPPModuleDataService : AbstractProjectDataService<ModuleData, Void>() {
    ...
    override fun postProcess(
        ...
        for (nodeToImport in toImport) {
            ...
            val activeSourceSetInfos =
                nodeToImport.kotlinAndroidSourceSets?.filter { it.kotlinModule.name.startsWith(variantName) } ?: emptyList()
    ...
    private fun addExtraDependeeModules(
        ...
        val testKotlinModules =
            gradleSourceSetDataNodes.filter { it.kotlinSourceSet?.isTestModule ?: false }
