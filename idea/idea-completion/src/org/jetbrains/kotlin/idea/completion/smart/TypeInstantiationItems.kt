        ...
        if (isAbstract) {
            ...
            signatureText = when (visibleConstructors.size) {
                ...
                1 -> {
                    ...
                    val substitutedConstructor =
                        constructor.substitute(substitutor) ?: constructor // render original signature if failed to substitute
            ...
            val baseInsertHandler = when (visibleConstructors.size) {
                ...
                1 -> (lookupElementFactory.insertHandlerProvider
                    .insertHandler(visibleConstructors.single()) as KotlinFunctionInsertHandler.Normal)
